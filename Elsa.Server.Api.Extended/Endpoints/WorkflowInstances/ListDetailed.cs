...
namespace Elsa.Server.Api.Endpoints.WorkflowInstances
{
    [ApiController]
    [ApiVersion("1")]
    [Route("v{apiVersion:apiVersion}/workflow-instances/detail")]
    [Produces("application/json")]
    public class ListDetailed : Controller
    {
        ...
        public ListDetailed(IWorkflowInstanceStore workflowInstanceStore, IMapper mapper, IContentSerializer contentSerializer, ILogger<List> logger, ITenantAccessor tenantAccessor)
        {
        ...
        [SwaggerOperation(
            ...
            Description = "Returns a paginated a list of workflow instances, inlcuding any blocking activities",
            OperationId = "WorkflowInstances.ListDetailed",
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var model = new PagedList<WorkflowInstance>(workflowInstances, page, pageSize, totalCount);
